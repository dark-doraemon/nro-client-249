...
public class LoginScr : mScreen, IActionListener
{
	...
	public void doLogin()
	{
		...
		Service.gI().login(text, text2, GameMidlet.VERSION, isLogin2 ? ((sbyte)1) : ((sbyte)0));
		Res.outz(Controller.isEXTRA_LINK + " = Controller.isEXTRA_LINK " + text + " " + text2 + " " + GameMidlet.VERSION + " " + (isLogin2 ? ((sbyte)1) : ((sbyte)0)));
